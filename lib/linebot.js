...
class LineBot extends EventEmitter {
  ...
  constructor(options) {
    ...
    this.options.channelId = options.channelId || '1654562128';
    this.options.channelSecret = options.channelSecret || 'c4a8aec2069a84c891227d202310d5c9';
    this.options.channelAccessToken = options.channelAccessToken || 'h1WXyFwx3GGxU5780i/y6RcV1d2qGo4IvBFPTLwQf9JQ/Gohe8hGc2LkthJEBGa2PEqZMzxjA1HtjkDYsmRVRXtKAF6YSD28qaCYypcUtvY+sLceG4rbs5VNBNg2XhwF5bIpBDHNXsuAnV0E8yCBOgdB04t89/1O/w1cDnyilFU=';
